      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex gap-3">
            ...
            <Button onClick={() => router.push('/import')} variant="secondary" size="md">
              Import Data
            </Button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">
                  Export to CSV, Excel, JSON, or PDF formats
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-gray-900 mb-2">Custom Fields</h3>
                <p className="text-sm text-gray-600">
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-gray-900 mb-2">Schedule Exports</h3>
                <p className="text-sm text-gray-600">
                  Set up recurring automated exports
                </p>
              </div>
            </div>
          </CardContent>
