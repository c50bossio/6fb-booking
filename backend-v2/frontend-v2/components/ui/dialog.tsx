  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        ...
        'bg-white/80 dark:bg-gray-900/80', // Fallback for bg-background
    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          'bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700', // Fallback for bg-background and border
          'max-h-[85vh] m-4 overflow-y-auto', // Prevent cutoff and add scrolling for tall content
          'sm:top-[50%] sm:translate-y-[-50%] max-sm:top-[20px] max-sm:translate-y-0', // Better mobile positioning
