...
const buttonVariants = cva(
  ...
  'inline-flex items-center justify-center font-medium transition-all duration-200 ease-ios focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed touch-manipulation relative overflow-hidden',
  {
    variants: {
      variant: {
        primary: [
          'bg-premium-primary hover:bg-premium-primary-hover text-white font-semibold',
          'shadow-premium hover:shadow-premium-colored transition-all duration-200 ease-ios',
        ...
        secondary: [
          'bg-white/90 dark:bg-dark-surface-200 text-ios-gray-900 dark:text-ios-gray-100 font-medium',
          'border border-ios-gray-200 dark:border-ios-gray-600 shadow-card hover:shadow-card-hover',
          'hover:bg-white dark:hover:bg-dark-surface-300 hover:border-ios-gray-300',
          'focus:ring-2 focus:ring-primary-500/30 focus:ring-offset-2 focus:border-primary-300',
        ...
        outline: [
          'bg-white/10 backdrop-blur-sm border-2 border-primary-500/60 text-primary-600 dark:text-primary-400 font-medium',
          'hover:bg-primary-50/80 dark:hover:bg-primary-950/30 hover:border-primary-600 hover:shadow-glow-primary-subtle',
          'focus:ring-2 focus:ring-primary-500/50 focus:ring-offset-2 focus:border-primary-600',
          'active:scale-95 transform-gpu will-change-transform transition-all duration-200 ease-ios',
          'shadow-glass hover:shadow-premium-soft backdrop-blur-md',
