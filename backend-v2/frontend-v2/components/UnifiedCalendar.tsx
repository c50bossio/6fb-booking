...
import { touchDragManager, TouchDragManager } from '@/lib/touch/touch-utils'
import { useSwipeNavigation } from '@/lib/mobile-touch-enhancements'
import { useCalendarTouchGestures } from '@/hooks/touch/useAdvancedTouchGestures'
import { useTouchFeedback } from '@/hooks/touch/useTouchFeedback'
import { useTouchPrediction } from '@/lib/touch/touch-prediction'
...
import { useCalendarOptimization } from '@/hooks/performance/useCalendarOptimization'
