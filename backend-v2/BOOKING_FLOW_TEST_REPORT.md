...
1. `GET /api/v2/appointments/slots?appointment_date=YYYY-MM-DD` ✅
2. `GET /api/v2/appointments/slots/next-available` ✅
3. `POST /api/v2/appointments` ✅
4. `POST /api/v2/appointments/guest` ✅
5. `POST /api/v2/appointments/guest/quick` ✅
