#!/bin/bash
# Auto-generated agent executor for agent_1

set -euo pipefail

AGENT_ID="agent_1"
INSTRUCTIONS_FILE="/Users/bossio/conductor/repo/6fb-booking/los-angeles/backend-v2/migrations/task_logs/agent_1_instructions.md"
LOG_FILE="/Users/bossio/conductor/repo/6fb-booking/los-angeles/backend-v2/migrations/agent_logs/agent_1.log"
...
cleanup() {
    ...
    rm -f "/Users/bossio/conductor/repo/6fb-booking/los-angeles/backend-v2/migrations/coordination/agent_1.pid"
}
trap cleanup EXIT

# Store PID
echo $$ > "/Users/bossio/conductor/repo/6fb-booking/los-angeles/backend-v2/migrations/coordination/agent_1.pid"
