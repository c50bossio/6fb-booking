...
export default function ClientMessageModal({ isOpen, onClose, client }: ClientMessageModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await axios.post(
        `${process.env.NEXT_PUBLIC_API_URL}/clients/${client.id}/message`,
        formData,
        { headers }
      )
              ...
              <Dialog.Panel className="w-full max-w-lg transform overflow-hidden rounded-2xl bg-white dark:bg-gray-900 p-6 text-left align-middle shadow-xl transition-all">
                ...
                <form onSubmit={handleSubmit} className="mt-6 space-y-6">
                  ...
                  <div className="space-y-3">
                    <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300">Send via</h4>
                    ...
                    <label className="flex items-center space-x-3">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm text-gray-700 dark:text-gray-300">Email ({client?.email})</span>
                      </div>
                    </label>
                    ...
                    <label className="flex items-center space-x-3">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm text-gray-700 dark:text-gray-300">SMS ({client?.phone})</span>
                      </div>
                    </label>
                  </div>
