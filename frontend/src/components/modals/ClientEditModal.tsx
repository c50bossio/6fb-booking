...
export default function ClientEditModal({
  ...
  // Theme helper functions using the exact pattern from ServiceEditModal
  ...
  useEffect(() => {
    if (client) {
      setFormData({
        ...
        email: client.email,
        phone: client.phone,
        date_of_birth: "", // Note: Not in the Client interface, but in CreateClientRequest
        notes: client.notes || "",
        tags: client.tags || [],
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    <CalendarDaysIcon className={`absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 ${themeClasses.iconColor}`} />
                    <input
                      type="date"
