...
const demoUser = {
  first_name: 'Demo',
  last_name: 'User',
  email: 'demo@sixfigurebarber.com',
  role: 'admin',
  location: 'Elite Cuts Studio'
}
...
export default function DemoSidebar({ onNavigate }: DemoSidebarProps) {
  ...
  const handleLogout = () => {
    // Demo logout - just redirect to main page
          ...
          {!isCollapsed && (
            <div className="flex-1 min-w-0">
              ...
              <p className="text-gray-400 text-xs truncate">
                {formatRole(demoUser.role)} • {demoUser.location}
              </p>
            </div>
          )}
        </div>
      ...
      <div className="px-4 py-4 border-t border-white/10 space-y-2">
        ...
        <div className="pt-2 border-t border-white/5">
          ...
          <button
            ...
            className="sidebar-nav-item w-full text-blue-400 hover:text-blue-300 hover:bg-blue-500/10"
            title={isCollapsed ? 'View Source' : undefined}
          >
