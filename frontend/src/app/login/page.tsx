        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="mt-8">
            ...
            <button 
              ...
              className="mt-6 w-full py-3 px-4 border border-gray-800 rounded-xl text-gray-300 hover:bg-gray-900/50 transition-all duration-200 flex items-center justify-center space-x-2"
            >
            ...
            <button className="mt-3 w-full py-3 px-4 border border-gray-800 rounded-xl text-gray-300 hover:bg-gray-900/50 transition-all duration-200 flex items-center justify-center space-x-2">
