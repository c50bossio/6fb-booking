        ...
        <div className="relative z-10 p-4 md:p-6 space-y-6 md:space-y-8">
          ...
          <div className="text-center space-y-4">
            <div className="flex items-center justify-center space-x-4">
              <div className="p-4 bg-gradient-to-br from-violet-500 to-purple-600 rounded-2xl shadow-2xl">
                <CalendarDaysIcon className="h-12 w-12 text-white" />
              </div>
            </div>
            <div>
              <h1 className="text-4xl lg:text-6xl font-bold text-white mb-4">Calendar Modals Demo</h1>
              <p className="text-purple-200 text-lg lg:text-xl max-w-3xl mx-auto">
                Experience our beautiful, functional modal system for appointment management. 
                Each modal features premium dark theme styling with glass morphism effects.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 hover:bg-white/20 transition-all duration-300 hover:-translate-y-1 group">
              <div className="flex items-center space-x-4 mb-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white">Create Appointment</h3>
                  <p className="text-purple-200 text-sm">Full appointment creation flow</p>
                </div>
              </div>
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 hover:bg-white/20 transition-all duration-300 hover:-translate-y-1 group">
              <div className="flex items-center space-x-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-purple-200 text-sm">View and edit appointments</p>
                </div>
              </div>
              <p className="text-purple-300 text-sm mb-6">
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 hover:bg-white/20 transition-all duration-300 hover:-translate-y-1 group">
              <div className="flex items-center space-x-4 mb-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white">Client Selection</h3>
                  <p className="text-purple-200 text-sm">Search and select clients</p>
                </div>
              </div>
              <p className="text-purple-300 text-sm mb-6">
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 hover:bg-white/20 transition-all duration-300 hover:-translate-y-1 group">
              <div className="flex items-center space-x-4 mb-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white">Service Selection</h3>
                  <p className="text-purple-200 text-sm">Browse services with pricing</p>
                </div>
              </div>
              <p className="text-purple-300 text-sm mb-6">
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 hover:bg-white/20 transition-all duration-300 hover:-translate-y-1 group">
              <div className="flex items-center space-x-4 mb-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white">Time Slot Picker</h3>
                  <p className="text-purple-200 text-sm">Visual time selection</p>
                </div>
              </div>
              <p className="text-purple-300 text-sm mb-6">
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 hover:bg-white/20 transition-all duration-300 hover:-translate-y-1 group">
              <div className="flex items-center space-x-4 mb-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white">Confirmation Dialog</h3>
                  <p className="text-purple-200 text-sm">Action confirmations</p>
                </div>
              </div>
              <p className="text-purple-300 text-sm mb-6">
          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl p-8 shadow-2xl max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-violet-300">🎨 Design Features</h3>
                <ul className="space-y-2 text-purple-200 text-sm">
                  <li>• Glass morphism with backdrop blur</li>
                  <li>• Premium dark theme with violet accents</li>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-violet-300">⚡ Functionality</h3>
                <ul className="space-y-2 text-purple-200 text-sm">
