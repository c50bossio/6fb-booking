...
def main():
    ...
    origins_to_test = [
        ...
        "https://bookbarber-6fb.vercel.app",  # Vercel deployment
    ]
    ...
    for result in results:
        ...
        print(f"{status} {result['origin']}: {result['passed']}/{result['total_tests']} tests passed")
    
    overall_success = sum(r['passed'] for r in results) / sum(r['total_tests'] for r in results)
