...
from services.query_optimization_service import get_query_performance_report, DatabaseOptimizer
...
async def get_table_statistics(
    ...
    allowed_tables = ['appointments', 'clients', 'barbers', 'users', 'payments', 'reviews']
