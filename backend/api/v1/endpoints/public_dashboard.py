...
async def get_demo_todays_appointments(
    ...
    clients = [
        {"name": "Marcus Johnson", "email": "marcus.j@email.com", "phone": "(555) 123-4567"},
        {"name": "DeAndre Williams", "email": "deandre.w@email.com", "phone": "(555) 234-5678"},
        {"name": "Jaylen Carter", "email": "jaylen.c@email.com", "phone": "(555) 345-6789"},
        {"name": "Isaiah Brooks", "email": "isaiah.b@email.com", "phone": "(555) 456-7890"},
        {"name": "Malik Johnson Jr.", "email": "malik.sr@email.com", "phone": "(555) 567-8901"},
        {"name": "Darius Thompson", "email": "darius.t@email.com", "phone": "(555) 678-9012"},
        {"name": "Jordan Mitchell", "email": "jordan.m@email.com", "phone": "(555) 789-0123"},
        {"name": "Xavier Davis", "email": "xavier.d@email.com", "phone": "(555) 890-1234"}
    ]
...
async def get_demo_calendar_events(
    ...
    barbers = ["DJ Williams", "Carlos Rodriguez", "Mike Thompson", "Tony Jackson"]
    services = [
        {"name": "Signature Cut + Beard Trim", "duration": 60, "price": 65, "color": "#8B5CF6"},
        {"name": "Classic Fade", "duration": 30, "price": 35, "color": "#3B82F6"},
        {"name": "Beard Shape Up", "duration": 20, "price": 25, "color": "#10B981"},
        {"name": "Full Service Cut + Wash", "duration": 45, "price": 55, "color": "#F59E0B"},
    ...
    while current_date <= end_date:
        ...
        if current_date.weekday() != 6:
            ...
            for _ in range(num_appointments):
                ...
                start_time = datetime.combine(current_date, datetime.min.time().replace(hour=hour, minute=minute))
                ...
                events.append({
                    ...
                    "extendedProps": {
                        ...
                        "price": service["price"],
                        "status": "confirmed" if current_date >= date.today() else "completed"
                    }
                })
                event_id += 1
    ...
    return {
        "events": events,
        "resources": [
            {"id": barber, "title": barber} for barber in barbers
        ]
    }