...
async def get_todays_appointments(
    ...
    try:
                ...
                appointments.append(
                    {
                        ...
                        "time": (
                            row.appointment_time.strftime("%I:%M %p")
                        ...
                        "service": {
                            ...
                            "price": (
                                float(row.service_revenue) if row.service_revenue else 0
                            ),
                        },
                        "client": {
                            "name": "Customer",
                        ...
                        "barber": {"name": "Barber", "email": "barber@headlines.com"},
        ...
        return {"error": str(e), "appointments": [], "stats": {}}
...
async def get_week_appointments(
    ...
    try:
        ...
        params = {"start_date": start_of_week, "end_date": end_of_week}
        ...
        return {"error": str(e), "daily_data": [], "totals": {}}
...
#                 a.trafft_appointment_id,
        ...
        params = {"today": now.date(), "current_time": now.time()}
