...
class TrainingModule(Base):
    ...
    )  # basic, intermediate, advanced, specialty
    ...
    content_type = Column(
        String(50), nullable=False
    )  # video, document, interactive, exam
...
class Certification(Base):
    ...
    user_certifications = relationship(
        "UserCertification", back_populates="certification"
    )
...
class SkillAssessment(Base):
    ...
    assessment_type = Column(
        String(100), nullable=False
    )  # practical, theoretical, observation
    skill_category = Column(
        String(100), nullable=False
    )  # cutting, customer_service, business, etc.
