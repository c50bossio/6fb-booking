...
class RevenueShare(Base):
    ...
    period_type = Column(String(20), nullable=False)  # daily, weekly, bi-weekly, monthly
...
class Commission(Base):
    ...
    component_type = Column(String(50), nullable=False)  # base, certification, performance, retention
