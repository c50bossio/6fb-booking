from sqlalchemy import Column, String, Date, DateTime, Integer, ForeignKey, Float, Text, Boolean
...
class Appointment(BaseModel):
    ...
    customer_type = Column(String(20), nullable=False)  # "New" or "Returning" - matches spreadsheet
    ...
    def total_revenue(self):
        ...
        return (self.service_revenue or 0) + (self.tip_amount or 0) + (self.product_revenue or 0)
