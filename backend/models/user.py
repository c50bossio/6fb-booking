...
class User(Base):
    ...
    role = Column(String(50), nullable=False, default="barber")  # super_admin, admin, mentor, barber, staff
    ...
    # 6FB Specific
    sixfb_certification_level = Column(String(50), nullable=True)  # bronze, silver, gold, platinum
    ...
    accessible_locations = Column(JSON, nullable=True)  # List of location IDs user can access
    ...
    def has_permission(self, permission: str) -> bool:
        ...
        role_permissions = {
            "admin": [
                "view_all_locations", "manage_locations", "view_all_analytics",
                "manage_users", "view_financial_data", "manage_automation"
            ],
            "mentor": [
                "view_assigned_locations", "view_mentee_analytics", "manage_training",
                "view_mentee_data", "create_reports", "manage_goals"
            ],
            "barber": [
                "view_own_data", "view_own_analytics", "manage_own_schedule",
                "view_clients", "update_profile"
            ],
            "staff": [
                "view_location_data", "manage_appointments", "view_clients"
            ]
        }
...
class UserSession(Base):
    ...
    location_id = Column(Integer, ForeignKey("locations.id"), nullable=True)  # Current working location
...
class UserActivity(Base):
    ...
    activity_type = Column(String(100), nullable=False)  # login, logout, view_report, etc.
    activity_description = Column(String(500), nullable=True)
    resource_type = Column(String(100), nullable=True)  # appointment, client, report, etc.
