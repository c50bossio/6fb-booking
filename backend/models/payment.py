...
class Payment(Base):
    ...
    # Payment type
    payment_type = Column(
        SQLAlchemyEnum(PaymentType), nullable=True, default=PaymentType.APPOINTMENT
    )
...
class StripeCustomer(Base):
    ...
    default_payment_method = relationship(
        "PaymentMethod", foreign_keys=[default_payment_method_id]
    )
