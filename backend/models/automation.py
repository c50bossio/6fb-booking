...
class AutomationRule(Base):
    ...
    )  # client_followup, performance_alert, booking_reminder
    ...
    trigger_type = Column(
        String(50), nullable=False
    )  # time_based, event_based, metric_based
    ...
    action_type = Column(
        String(50), nullable=False
    )  # send_sms, send_email, create_task, alert_manager
