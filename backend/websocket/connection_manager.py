...
class ConnectionManager:
    ...
    async def connect(self, websocket: WebSocket, user_id: int, location_id: int = None):
        ...
        try:
            while True:
                ...
                if message.get("type") == "ping":
                    ...
                    logger.warning(f"Unknown message type from user {user_id}: {message}")
    ...
    def get_connection_count(self) -> dict:
        ...
        return {
            ...
            "by_location": {
                loc_id: len(users) for loc_id, users in self.location_connections.items()
            }
        }
