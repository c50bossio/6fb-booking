    ...
    try:
        ...
        appointments_data = [
            ...
            },
            {
                ...
                "date": today,
                "time": datetime.combine(
                    today, datetime.strptime("10:30", "%H:%M").time()
                ),
            ...
            },
            {
                ...
                "date": today,
                "time": datetime.combine(
                    today, datetime.strptime("14:00", "%H:%M").time()
                ),
                "service_revenue": 50.0,
                "tip": 10.0,
                "service": "Haircut",
                "status": "in_progress",
            },
            {
                ...
                "date": today,
                "time": datetime.combine(
                    today, datetime.strptime("15:30", "%H:%M").time()
                ),
                "service_revenue": 70.0,
                "tip": 0.0,
                "service": "Cut + Beard",
                "status": "scheduled",
            },
            {
                ...
                "date": today,
                "time": datetime.combine(
                    today, datetime.strptime("17:00", "%H:%M").time()
                ),
                "service_revenue": 45.0,
                "tip": 0.0,
                "service": "Standard Cut",
