...
class PaymentSystemActivator:
    ...
    def check_environment(self) -> bool:
        ...
        if not settings.STRIPE_WEBHOOK_SECRET:
            self.print_warning("STRIPE_WEBHOOK_SECRET not configured - webhooks won't work")
        else:
        ...
        try:
            ...
            if hasattr(account, "capabilities"):
                ...
                if caps.transfers != "active":
                    self.print_warning("Transfers not fully activated - needed for payouts")
    ...
    def test_payment_flow(self) -> bool:
        ...
        try:
            ...
            if payment_intent.status == "requires_payment_method":
                self.print_info("Payment intent created successfully (awaiting payment method)")
    ...
    def test_payout_calculation(self) -> bool:
        ...
        if barber.is_booth_renter:
            ...
            shop_payout = 0
            self.print_info("Booth renter - gets full amount (booth rent calculated separately)")
        else:
            # Commission-based
    ...
    def generate_activation_report(self):
        ...
        report = {
            ...
            "stripe_mode": "live" if settings.STRIPE_SECRET_KEY.startswith("sk_live_") else "test",
