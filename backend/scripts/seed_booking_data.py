...
from models.booking import (
    ServiceCategory, Service, BookingRule, DayOfWeek, BarberAvailability
)
...
def seed_booking_rules(db: Session):
    ...
    for rule_data in rules:
        rule = db.query(BookingRule).filter_by(
...
def seed_sample_availability(db: Session):
    ...
    for schedule_data in all_schedules:
        availability = db.query(BarberAvailability).filter_by(
    ...
    db.commit()
    print(f"Seeded sample availability for barber {barber.first_name} {barber.last_name}")
