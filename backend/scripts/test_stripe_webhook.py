...
def test_payment_succeeded():
    ...
    data = {
        ...
        "metadata": {"user_id": "1", "appointment_id": "1"},
    }
...
def test_refund_updated():
    ...
    data = {
        ...
        "currency": "usd",
        "metadata": {"payment_id": "1", "reason": "Customer request"},
...
def test_payment_method_attached():
    ...
    data = {
        ...
        "card": {"brand": "visa", "exp_month": 12, "exp_year": 2025, "last4": "4242"},
        "customer": "cus_test_customer",
        "type": "card",
    }
...
def main():
    ...
    print(
        "3. Forward: stripe listen --forward-to localhost:8000/api/v1/webhooks/stripe"
    )
