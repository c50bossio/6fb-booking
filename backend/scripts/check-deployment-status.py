...
def check_deployment_status():
    ...
    try:
        ...
        health_response = requests.get("https://sixfb-backend.onrender.com/health", timeout=10)
        ...
        try:
            docs_response = requests.get("https://sixfb-backend.onrender.com/docs", timeout=10)
            print(f"Docs Endpoint: {'✓ Available' if docs_response.status_code == 200 else '✗ Not Available'}")
        except:
