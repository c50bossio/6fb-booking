...
import os
os.environ['DATABASE_URL'] = 'postgresql://sixfb_backend_user:8dqe29qP09dmHnOLJcF3pbw6M3GwAV6L@dpg-d19lc6h5pdvs739sq850-a.oregon-postgres.render.com/sixfb_backend'
...
with engine.connect() as conn:
    try:
        ...
        # Check count
        count_result = conn.execute(text("SELECT COUNT(*) FROM appointments WHERE appointment_date = CURRENT_DATE"))
