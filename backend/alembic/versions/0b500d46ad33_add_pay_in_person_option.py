...
def upgrade() -> None:
    ...
    with op.batch_alter_table('locations', schema=None) as batch_op:
        batch_op.add_column(sa.Column('pay_in_person_enabled', sa.Boolean(), nullable=False, server_default='true'))
        batch_op.add_column(sa.Column('pay_in_person_message', sa.Text(), nullable=True))
