...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("sent", "delivered", "failed", "undelivered", name="smsstatus"),
            nullable=False,
        ),
        sa.Column("sent_at", sa.DateTime(), nullable=True),
        sa.Column("delivered_at", sa.DateTime(), nullable=True),
    ...
    op.create_index(
        op.f("ix_sms_logs_recipient"), "sms_logs", ["recipient"], unique=False
    )
    op.create_index(op.f("ix_sms_logs_status"), "sms_logs", ["status"], unique=False)
    op.create_index(
        op.f("ix_sms_logs_twilio_sid"), "sms_logs", ["twilio_sid"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_communication_templates_name"),
        "communication_templates",
        ["name"],
        unique=True,
    )
    op.create_index(
        op.f("ix_communication_templates_type"),
        "communication_templates",
        ["type"],
        unique=False,
    )
...
def downgrade():
    ...
    op.drop_index(
        op.f("ix_communication_templates_type"), table_name="communication_templates"
    )
    op.drop_index(
        op.f("ix_communication_templates_name"), table_name="communication_templates"
    )
