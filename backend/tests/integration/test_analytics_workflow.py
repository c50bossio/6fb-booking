...
class TestAnalyticsWorkflow:
    ...
    def test_analytics_data_generation_workflow(self):
        ...
        analytics_response = client.get(
            f"/api/v1/analytics/barber/{barber_id}", headers=headers
        )
        ...
        location_analytics_response = client.get(
            "/api/v1/analytics/location/1", headers=headers
        )
    ...
    def test_performance_metrics_workflow(self):
        ...
        endpoints = ["/api/v1/locations", "/api/v1/analytics/dashboard", "/health"]
