...
def test_data(test_db):
    ...
    for i in range(20):
        ...
        appointment = Appointment(
            ...
            appointment_time=datetime.combine(
                appointment_date, datetime.min.time().replace(hour=10 + (i % 8))
            ),
    ...
    return {"location": location, "barber": barber, "clients": clients}
...
class TestAnalyticsAPI:
    ...
    def test_unauthorized_access(self, client):
        ...
        response = client.get(
            "/api/v1/analytics/revenue?start_date=2024-01-01&end_date=2024-01-31"
        )
    ...
    def test_permission_checks(self, client, test_db):
        ...
        response = client.get("/api/v1/analytics/network-insights", headers=headers)
