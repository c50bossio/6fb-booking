...
def check_environment():
    ...
    try:
        result = subprocess.run(['git', 'status', '--porcelain'], 
                              capture_output=True, text=True, cwd='/Users/bossio/6fb-booking/backend')
    ...
    if 'railway.app' in allowed_origins:
        ...
        checks.append(("⚠️", "CORS", "Railway URL not explicitly in ALLOWED_ORIGINS (but handled dynamically)"))
...
def show_deployment_commands():
    ...
    print("2. Test CORS: curl -H 'Origin: https://web-production-92a6c.up.railway.app' https://your-backend-url/cors-test")
    print("3. Test preflight: curl -X OPTIONS -H 'Origin: https://web-production-92a6c.up.railway.app' https://your-backend-url/api/v1/health")
