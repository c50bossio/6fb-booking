...
def test_api_endpoints():
    ...
    tests = [
        ...
        {
            "url": f"{base_url}/api/analytics/dashboard?barber_id=1",
            "name": "Dashboard analytics",
        },
        {
            "url": f"{base_url}/api/analytics/daily-metrics?barber_id=1",
            "name": "Daily metrics",
        },
        {"url": f"{base_url}/api/analytics/6fb-score?barber_id=1", "name": "6FB Score"},
        {
            "url": f"{base_url}/api/appointments/daily-summary?barber_id=1",
